...
import { runPrompt, escalationUseful } from '../prompts/index.js';
...
/** Is escalating to Tier 2 worth a call now? False while Tier 2 is degraded (prompts/index.js). */
export function sortEscalationUseful(userId) {
  return escalationUseful(userId);
}
